...
var WURLD = {
    ...
    // TODO: Implement this in the WurldInput class
    listener: null,
    ...
    startUp: function(){
		...
		WURLD.physics = new WurldPhysics(WURLD_SETTINGS.last_location.x,WURLD_SETTINGS.last_location.y);
        ...
        WURLD.sun.position.addVectors(WURLD_SETTINGS.last_location,WURLD.light_position);
        WURLD.sun.target.position.copy(WURLD_SETTINGS.last_location);

        WURLD.sun.castShadow = true;
        WURLD.sun.shadow.mapSize.width = WURLD.shadow_map_size;
        WURLD.sun.shadow.mapSize.height = WURLD.shadow_map_size;
    ...
    render: function() {
        ...
        if(WURLD.player_avatar){
            ...
            // Update the sun so that the shadows follow the player around
